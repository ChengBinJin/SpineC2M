...
tf.flags.DEFINE_bool('is_alterative_optim', False, 'optimizing by alterative or integrated optimziation. default: True')
...
tf.flags.DEFINE_integer('iters', 6, 'number of iterations, default: 200000')
